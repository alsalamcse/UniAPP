...
public class SevenDaysAdapter extends RecyclerView.Adapter<SevenDaysAdapter.ViewHolder> {
    ...
    public SevenDaysAdapter(List<Exams> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_sevendays, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mIdView.setText(mValues.get(position).getExamDate());
        holder.mContentView.setText(mValues.get(position).getExamName());
